...
import com.example.ms_bank_customer_transaction.model.CreditType;
import com.example.ms_bank_customer_transaction.repository.CreditProductRepository;
import com.example.ms_bank_customer_transaction.service.ICreditProductService;
...
public class CreditProductService implements ICreditProductService {
    ...
    public Mono<CreditProduct> createCreditProduct(CreditProduct creditProduct) {
        return creditProductRepository.findByCustomerId(creditProduct.getCustomerId())
                .collectList()
