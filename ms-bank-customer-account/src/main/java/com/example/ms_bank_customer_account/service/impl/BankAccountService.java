...
public class BankAccountService implements IBankAccountService {
    ...
    @Override
    public Flux<BankAccount> findByClientTypeAndAccountType(ClientType clientType, AccountType accountType) {
        return bankAccountRepository.findByClientTypeAndAccountType(clientType,accountType);
    }
